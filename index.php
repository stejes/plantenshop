...
if (isset($_GET['page'])) {
    ...
    switch ($page) {
        ...
        case "ajaxshop":
            ...
            //$tpl['paginaScripts'] = getScriptElements(array("js/vendor/jquery/DataTables/js/jquery.dataTables.min.js", "js/shop.js"));
            $tpl['paginaScripts'] = getScriptElements(array("js/vendor/jquery/DataTables/js/jquery.dataTables.min.js", "js/ajaxshop.js"));
            $tpl['paginaStylesheets'] = getLinkElements("js/vendor/jquery/Datatables/css/jquery.dataTables.css");
            break;
        ...
        case "galerij":
            ...
            $tpl['paginaScripts'] = getScriptElements(array("js/vendor/jquery/lightbox/src/js/lightbox.js", "js/vendor/"
                . "jquery/js/jquery.ui.knipoog.js", "js/galerij.js"));
            $tpl['paginaStylesheets'] = getLinkElements("js/vendor/jquery/lightbox/src/css/lightbox.css");
        ...
        case "registreer":
            ...
            $tpl['paginaScripts'] = getScriptElements(array("js/vendor/jquery/validate/dist/jquery.validate.min.js",
                "js/registreer.js"));
            break;
