...
//hierboven werkte niet als ge de ajax_json_dt_planen vanuit services rechtstreeks aanroept, dit gekopieer van plantenservice
...
class PlantenDAO extends AbstractDAO{
	...
	public function getJSON_dt_PlantenAdvanced($soort_id, $kleur, $hoogte_min, $hoogte_max){
			...
			//echo $sqlAlleCriteria;
                        //echo "<script type='text/javascript'>alert('$sqlAlleCriteria');</script>";
			// 
			$jsonArray = array();
